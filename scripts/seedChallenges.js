...
const DAILY = [
  ...
  ch('Best Skyline View', 'Find the best skyline view', { type: 'outdoors', difficulty: 'MEDIUM' }),
  ch('Moon Tonight', 'Snap the moon tonight', { type: 'outdoors' }),
  ...
  ch('View From A Bridge', 'Show the best view from a bridge', { type: 'outdoors', difficulty: 'MEDIUM' }),
  ch('Something Green', 'Snap something green', { type: 'outdoors' }),
  ch('Favorite Trail or Path', 'Show your favorite trail or path', { type: 'outdoors' }),
  ...
  ch('Local Landmark', 'Show a local landmark', { type: 'city' }),
  ...
  ch('Museum, Gallery, or Cultural Spot', 'Snap a museum, gallery, or cultural spot', { type: 'art', difficulty: 'MEDIUM' }),
  ...
  ch('Running Trail', 'Find a running trail', { type: 'fitness' }),
  ...
  ch('Sports Field or Stadium', 'Find a sports field or stadium', { type: 'fitness', difficulty: 'MEDIUM' }),
